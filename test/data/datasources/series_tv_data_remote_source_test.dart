...
void main() {
  ...
  group('get On The Air Tv Series', () {
    final tSeriesTvList = ResponseSeriesTv.fromJson(
    ...
    test('should return list of Tv Series Model when the response code is 200',
          ...
          // assert
          expect(result, equals(tSeriesTvList));
        });
  ...
  group('get Tv Series detail', () {
    final tId = 1;
    final tSeriesTvDetail = DetailResponseSeriesTv.fromJson(
        json.decode(readJson('dummy_data/detail_series_tv.json')));
    ...
    test('should return tv series detail when the response code is 200',
          ...
          when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$tId?$API_KEY')))
              .thenAnswer((_) async => http.Response(
              readJson('dummy_data/detail_series_tv.json'), 200,
              headers: {
                HttpHeaders.contentTypeHeader:
                'application/json; charset=utf-8',
              }));
          ...
          // assert
          expect(result, equals(tSeriesTvDetail));
        });
  ...
  group('get Tv Series recommendations', () {
    final tSeriesTvList = ResponseSeriesTv.fromJson(
        json.decode(readJson('dummy_data/recommendations_series_tv.json')))
        .tvList;
    final tId = 1;
    ...
    test('should return list of  Series Tv Model when the response code is 200',
          ...
          when(mockHttpClient
              ...
              .thenAnswer((_) async => http.Response(
              readJson('dummy_data/recommendations_series_tv.json'), 200));
          // act
